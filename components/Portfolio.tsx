        ...
        <div className="mb-12">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-12 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
              ...
              <h3 className="font-orbitron font-black text-4xl md:text-6xl leading-tight text-white mb-8 uppercase tracking-tighter">UAU CODE <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-fuchsia-500">.app</span></h3>
              <p className="text-slate-300 max-w-2xl mb-10 font-light text-lg leading-relaxed">Desenvolvimento completo de leitura de imagens, interação e incorporação de conteúdos.</p>
